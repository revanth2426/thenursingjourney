  ...
  head: () => ({
    meta: [
      { title: "Refund Policy - The Nursing Journey – Siva Naik" },
      {
        name: "description",
        content:
          "Read our Refund Policy to understand the terms and conditions for refunds and cancellations.",
      },
    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 pt-32 sm:px-6 lg:px-8">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            At The Nursing Journey – Siva Naik, we strive to provide high-quality services to our
            clients. If you are not satisfied with our services, we offer a refund policy as
            described below.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            You may cancel a service request by notifying us via WhatsApp or email. Cancellation
            requests must be made in writing and include your name, contact details, and the service
            you wish to cancel.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Refund eligibility depends on the stage of service completion at the time of
            cancellation:
          </p>
          <ul className="list-disc list-inside mb-4 space-y-2">
            <li>
              <strong>Full Refund:</strong> If you cancel within 7 days of payment AND no work has
              been performed (no document review, no council submission, no draft preparation), you
              are eligible for a full refund.
            </li>
            <li>
              <strong>Partial Refund (50%)</strong>: If work has commenced but no government/council
              submission has been made, you are eligible for a 50% refund.
            </li>
            <li>
              <strong>No Refund:</strong> Once any document has been submitted to a nursing council,
              government authority, or third party on your behalf, no refund will be provided.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Approved refunds will be processed within 15 business days to the original payment
            method.
          </p>
        </section>
